...
public class BuildObject {
	...
	private List<BuildPicObject> buildPicurl;

	

	public List<BuildPicObject> getBuildPicurl() {
		return buildPicurl;
	}

	public void setBuildPicurl(List<BuildPicObject> list) {
		this.buildPicurl = list;
	}
